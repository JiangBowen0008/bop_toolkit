...
def get_model_params(datasets_path, dataset_name, model_type=None):
  ...
  obj_ids = {
    ...
    'custom-grasp': list(range(1, 135)),                        # list(range(1, 25))
    'custom-suction': list(range(149, 259)),                    # list(range(25, 46))
    'custom-comb': list(range(1, 135)) + list(range(149, 259))  # list(range(1, 46))
  }[dataset_name]
